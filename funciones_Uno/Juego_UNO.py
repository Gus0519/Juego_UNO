...
def jugar_turno(cartas_del_jugador, nombre_en_turno):  # (cartas_por_jugador[nombre],nombre)
    ...
    if len(cartas_jugables) > 0:  # si tiene cartas que pueda jugar
        ...
        time.sleep(0.5)
        print('EDA-16 Semestre 2022-2'.rjust(100,' '))
        print("De la rosa Lara Gustavo".rjust(100,' '))
        print("Dominguez Chavez Jesus Abner".rjust(100,' '))
        print("Silva Alarcón Cristina".rjust(100,' '))
...
time.sleep(1.0)
print("De la rosa Lara Gustavo -- Matricula: 318215961")
time.sleep(1.0)
print("Dominguez Chavez Jesus Abner -- Matricula: 319319969 ")
time.sleep(1.0)
print("Silva Alarcón Cristina -- Matricula : 319271108 ")
print('\n\n')
time.sleep(2.0)
